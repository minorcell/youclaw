...
export function SettingsPage() {
  ...
  const targetSessionId = activeSessionId ?? lastOpenedSessionId ?? sessions[0]?.id ?? null
...
export function SettingsModal({ open, onOpenChange }: SettingsModalProps) {
  ...
  const resetSettingsUiState = useSettingsStore((state) => state.resetSettingsUiState)
  ...
  }, [open, providerAccounts, resetSettingsUiState, selectedProviderId, setSelectedProviderId])
            ...
            <section className='flex min-h-0 flex-1 flex-col'>
              ...
              <ScrollArea className='min-h-0 flex-1'>
                <div className='px-4 py-5 sm:px-6 sm:py-6'>
                  ...
                  {section === 'memory' ? <AgentSettingsSection mode='files' /> : null}
                  {section === 'providers' ? (
